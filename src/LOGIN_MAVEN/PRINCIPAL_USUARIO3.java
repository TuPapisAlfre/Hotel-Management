...
public class PRINCIPAL_USUARIO3 extends javax.swing.JFrame {

    
    public PRINCIPAL_USUARIO3() {
        initComponents();
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        RESERVA_SPA2 newPanel = new RESERVA_SPA2
        ();
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        // Crea una instancia del nuevo panel INTERIOR_RESERVA
        RESERVA_HOTEL_1 newPanel = new RESERVA_HOTEL_1 ();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRINCIPAL_USUARIO3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
