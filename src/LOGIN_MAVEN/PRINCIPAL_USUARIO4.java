...
public class PRINCIPAL_USUARIO4 extends javax.swing.JFrame {

    
    public PRINCIPAL_USUARIO4() {
        initComponents();
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        RESERVA_SPA3 newPanel = new RESERVA_SPA3
        ();
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        // Crea una instancia del nuevo panel INTERIOR_RESERVA
        RESERVA_HOTEL_11 newPanel = new RESERVA_HOTEL_11 ();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRINCIPAL_USUARIO4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
