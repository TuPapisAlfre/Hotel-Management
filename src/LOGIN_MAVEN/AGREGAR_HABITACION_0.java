...
public class AGREGAR_HABITACION_0 extends javax.swing.JPanel {


         private DefaultTableModel modeloTabla;

    
    public AGREGAR_HABITACION_0() {
        initComponents();
        modeloTabla = new DefaultTableModel();
      modeloTabla.addColumn("NombreHabitacion");
modeloTabla.addColumn("TipoHabitacion");
...
String nombreHabitacion = jTextField1.getText();
    ...
    String precioText = jTextField2.getText();
    ...
    if (nombreHabitacion.isEmpty() || precioText.isEmpty()) {
    ...
    // URL de conexión a la base de datos SQL Server con SSL
    String url = "jdbc:sqlserver://Alfre:1433;" +
        "databaseName=PlayaParaiso_Samana2;" +
        "encrypt=true;" + 
