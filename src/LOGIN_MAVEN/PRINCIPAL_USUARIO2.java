...
public class PRINCIPAL_USUARIO2 extends javax.swing.JFrame {

    
    public PRINCIPAL_USUARIO2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Puerto Plata - Playa Cofresi");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 240, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRINCIPAL_USUARIO2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
