...
public class PRINCIPAL_USUARIO5 extends javax.swing.JFrame {

    
    public PRINCIPAL_USUARIO5() {
        initComponents();
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        RESERVA_SPA4 newPanel = new RESERVA_SPA4
        ();
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        // Crea una instancia del nuevo panel INTERIOR_RESERVA
        RESERVA_HOTEL_111 newPanel = new RESERVA_HOTEL_111 ();
  ...
  CONFIG registroFrame = new CONFIG();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRINCIPAL_USUARIO5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
