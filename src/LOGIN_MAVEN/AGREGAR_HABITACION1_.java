...
public class AGREGAR_HABITACION1_ extends javax.swing.JPanel {


         private DefaultTableModel modeloTabla;

    
    public AGREGAR_HABITACION1_() {
        initComponents();
...
String nombreHabitacion = jTextField1.getText();
    ...
    String url = "jdbc:sqlserver://Alfre:1433;" +
        "databaseName=PlayaParaiso_Samana2;" + // Asegúrate de que aquí esté el nombre correcto de la base de datos
        "encrypt=true;" + 
